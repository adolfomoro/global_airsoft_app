...
void main() {
  test('maps 400 responses without validation errors to UserFriendlyApiException', () {
  ...
  test('keeps 400 responses with validation errors as ValidationApiException', () {
    final ApiException exception = const ApiException(
